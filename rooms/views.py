...
def room_edit(request, room_id):
    ...
    doors = [val for val in edit_room.doors.values_list('next_room', flat=True) if val not in Room.objects.values_list('name', flat=True)] # delete if other door_dupe later
